...
# Date: Sat, 24 Feb 2018 22:31:45 GMT
#set_units -time ns
...
create_generated_clock -name {Master_Clk} -source [get_pins {ClockBlock/clk_sync}] -edges {1 2 3} [list [get_pins {ClockBlock/dclk_glb_0}]]
