...
// VDAC8_v1_90(Data_Source=0, Initial_Value=100, Strobe_Mode=1, VDAC_Range=0, VDAC_Speed=2, Voltage=400, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=WaveDAC8_2:VDAC8, CY_INSTANCE_SHORT_NAME=VDAC8, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=WaveDAC8_2_VDAC8, )
...
module ADC_DelSig_v3_20_8 (
	...
	cy_clock_v1_0
		#(.id("d20cd9a8-3121-46de-9189-c5a108740f4e/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("d20cd9a8-3121-46de-9189-c5a108740f4e/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("6250000000"),
		  .is_direct(0),
...
module top ;
    ...
    assign Net_1419 = 1'h0;

    assign Net_1407 = 1'h0;
    ...
    UART_v2_50_4 UART_1 (
        ...
        .reset(1'b0),
        .rx(Net_42),
        .tx_interrupt(Net_2620),
        .rx_interrupt(Net_2621),
        .tx_data(Net_2622),
        .tx_clk(Net_2623),
        .rx_data(Net_2624),
        .rx_clk(Net_2625));
	...
	cy_clock_v1_0
		#(.id("8f8a42d9-16d3-4d28-bb37-7b1d87f17287"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(2),
		  .period("0"),
		  .is_direct(0),
    ...
    OpAmp_v1_90_6 Opamp_1 (
        .Vplus(Net_2664),
        .Vout(Net_2641),
        .Vminus(Net_2666));
    defparam Opamp_1.Mode = 1;

    assign Net_2606 = 1'h0;
    ...
    ADC_DelSig_v3_20_8 ADC_DelSig_1 (
        .vplus(Net_2641),
        .vminus(Net_2650),
        .soc(1'b1),
        .eoc(Net_2652),
