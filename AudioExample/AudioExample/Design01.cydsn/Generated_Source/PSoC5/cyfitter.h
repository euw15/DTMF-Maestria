...
/* Audio */
#define Audio__0__INTTYPE CYREG_PICU3_INTTYPE0
#define Audio__0__MASK 0x01u
#define Audio__0__PC CYREG_PRT3_PC0
#define Audio__0__PORT 3u
#define Audio__0__SHIFT 0u
#define Audio__AG CYREG_PRT3_AG
#define Audio__AMUX CYREG_PRT3_AMUX
#define Audio__BIE CYREG_PRT3_BIE
#define Audio__BIT_MASK CYREG_PRT3_BIT_MASK
#define Audio__BYP CYREG_PRT3_BYP
#define Audio__CTL CYREG_PRT3_CTL
#define Audio__DM0 CYREG_PRT3_DM0
#define Audio__DM1 CYREG_PRT3_DM1
#define Audio__DM2 CYREG_PRT3_DM2
#define Audio__DR CYREG_PRT3_DR
#define Audio__INP_DIS CYREG_PRT3_INP_DIS
#define Audio__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU3_BASE
#define Audio__LCD_COM_SEG CYREG_PRT3_LCD_COM_SEG
#define Audio__LCD_EN CYREG_PRT3_LCD_EN
#define Audio__MASK 0x01u
#define Audio__PORT 3u
#define Audio__PRT CYREG_PRT3_PRT
#define Audio__PRTDSI__CAPS_SEL CYREG_PRT3_CAPS_SEL
#define Audio__PRTDSI__DBL_SYNC_IN CYREG_PRT3_DBL_SYNC_IN
#define Audio__PRTDSI__OE_SEL0 CYREG_PRT3_OE_SEL0
#define Audio__PRTDSI__OE_SEL1 CYREG_PRT3_OE_SEL1
#define Audio__PRTDSI__OUT_SEL0 CYREG_PRT3_OUT_SEL0
#define Audio__PRTDSI__OUT_SEL1 CYREG_PRT3_OUT_SEL1
#define Audio__PRTDSI__SYNC_OUT CYREG_PRT3_SYNC_OUT
#define Audio__PS CYREG_PRT3_PS
#define Audio__SHIFT 0u
#define Audio__SLW CYREG_PRT3_SLW

/* Mic */
#define Mic__0__INTTYPE CYREG_PICU3_INTTYPE1
#define Mic__0__MASK 0x02u
#define Mic__0__PC CYREG_PRT3_PC1
#define Mic__0__PORT 3u
#define Mic__0__SHIFT 1u
#define Mic__AG CYREG_PRT3_AG
#define Mic__AMUX CYREG_PRT3_AMUX
#define Mic__BIE CYREG_PRT3_BIE
#define Mic__BIT_MASK CYREG_PRT3_BIT_MASK
#define Mic__BYP CYREG_PRT3_BYP
#define Mic__CTL CYREG_PRT3_CTL
#define Mic__DM0 CYREG_PRT3_DM0
#define Mic__DM1 CYREG_PRT3_DM1
#define Mic__DM2 CYREG_PRT3_DM2
#define Mic__DR CYREG_PRT3_DR
#define Mic__INP_DIS CYREG_PRT3_INP_DIS
#define Mic__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU3_BASE
#define Mic__LCD_COM_SEG CYREG_PRT3_LCD_COM_SEG
#define Mic__LCD_EN CYREG_PRT3_LCD_EN
#define Mic__MASK 0x02u
#define Mic__PORT 3u
#define Mic__PRT CYREG_PRT3_PRT
#define Mic__PRTDSI__CAPS_SEL CYREG_PRT3_CAPS_SEL
#define Mic__PRTDSI__DBL_SYNC_IN CYREG_PRT3_DBL_SYNC_IN
#define Mic__PRTDSI__OE_SEL0 CYREG_PRT3_OE_SEL0
#define Mic__PRTDSI__OE_SEL1 CYREG_PRT3_OE_SEL1
#define Mic__PRTDSI__OUT_SEL0 CYREG_PRT3_OUT_SEL0
#define Mic__PRTDSI__OUT_SEL1 CYREG_PRT3_OUT_SEL1
#define Mic__PRTDSI__SYNC_OUT CYREG_PRT3_SYNC_OUT
#define Mic__PS CYREG_PRT3_PS
#define Mic__SHIFT 1u
#define Mic__SLW CYREG_PRT3_SLW
...
/* SignalSelector */
#define SignalSelector__0__INTTYPE CYREG_PICU2_INTTYPE2
#define SignalSelector__0__MASK 0x04u
#define SignalSelector__0__PC CYREG_PRT2_PC2
#define SignalSelector__0__PORT 2u
#define SignalSelector__0__SHIFT 2u
#define SignalSelector__AG CYREG_PRT2_AG
#define SignalSelector__AMUX CYREG_PRT2_AMUX
#define SignalSelector__BIE CYREG_PRT2_BIE
#define SignalSelector__BIT_MASK CYREG_PRT2_BIT_MASK
#define SignalSelector__BYP CYREG_PRT2_BYP
#define SignalSelector__CTL CYREG_PRT2_CTL
#define SignalSelector__DM0 CYREG_PRT2_DM0
#define SignalSelector__DM1 CYREG_PRT2_DM1
#define SignalSelector__DM2 CYREG_PRT2_DM2
#define SignalSelector__DR CYREG_PRT2_DR
#define SignalSelector__INP_DIS CYREG_PRT2_INP_DIS
#define SignalSelector__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU2_BASE
#define SignalSelector__LCD_COM_SEG CYREG_PRT2_LCD_COM_SEG
#define SignalSelector__LCD_EN CYREG_PRT2_LCD_EN
#define SignalSelector__MASK 0x04u
#define SignalSelector__PORT 2u
#define SignalSelector__PRT CYREG_PRT2_PRT
#define SignalSelector__PRTDSI__CAPS_SEL CYREG_PRT2_CAPS_SEL
#define SignalSelector__PRTDSI__DBL_SYNC_IN CYREG_PRT2_DBL_SYNC_IN
#define SignalSelector__PRTDSI__OE_SEL0 CYREG_PRT2_OE_SEL0
#define SignalSelector__PRTDSI__OE_SEL1 CYREG_PRT2_OE_SEL1
#define SignalSelector__PRTDSI__OUT_SEL0 CYREG_PRT2_OUT_SEL0
#define SignalSelector__PRTDSI__OUT_SEL1 CYREG_PRT2_OUT_SEL1
#define SignalSelector__PRTDSI__SYNC_OUT CYREG_PRT2_SYNC_OUT
#define SignalSelector__PS CYREG_PRT2_PS
#define SignalSelector__SHIFT 2u
#define SignalSelector__SLW CYREG_PRT2_SLW
