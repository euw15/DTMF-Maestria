...
// VDAC8_v1_90(Data_Source=0, Initial_Value=100, Strobe_Mode=1, VDAC_Range=0, VDAC_Speed=2, Voltage=400, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=WaveDAC8_1:VDAC8, CY_INSTANCE_SHORT_NAME=VDAC8, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=WaveDAC8_1_VDAC8, )
...
// OpAmp_v1_90(Mode=1, Power=2, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=OpAmp_v1_90, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=WaveDAC8_1:BuffAmp, CY_INSTANCE_SHORT_NAME=BuffAmp, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=WaveDAC8_1_BuffAmp, )
...
module WaveDAC8_v2_10_2 (
	...
	cy_clock_v1_0
		#(.id("90c503a8-4d82-472c-b888-2f06494563c2/77086516-855e-4b7b-abbe-47b22f8543de"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("5000000000"),
		  .is_direct(0),
...
module ADC_DelSig_v3_30_3 (
	...
	cy_clock_v1_0
		#(.id("1209012e-5a5c-4c0c-8662-b8c8536cd152/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("1209012e-5a5c-4c0c-8662-b8c8536cd152/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("7812500000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__SignalSelector_net;
	wire [0:0] tmpIO_0__SignalSelector_net;
	wire [0:0] tmpINTERRUPT_0__SignalSelector_net;
	electrical [0:0] tmpSIOVREF__SignalSelector_net;

	cy_psoc3_pins_v1_10
		#(.id("6b32cb85-cd6e-4639-a0b1-7db0fbcc4e16"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SignalSelector
		 (.oe(tmpOE__SignalSelector_net),
		  .y({1'b0}),
		  .fb({Net_7}),
		  .io({tmpIO_0__SignalSelector_net[0:0]}),
		  .siovref(tmpSIOVREF__SignalSelector_net),
		  .interrupt({tmpINTERRUPT_0__SignalSelector_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SignalSelector_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Mic_net;
	wire [0:0] tmpFB_0__Mic_net;
	wire [0:0] tmpIO_0__Mic_net;
	wire [0:0] tmpINTERRUPT_0__Mic_net;
	electrical [0:0] tmpSIOVREF__Mic_net;

	cy_psoc3_pins_v1_10
		#(.id("39b838f7-f7f4-44a1-9571-865940d8e2bd"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Mic
		 (.oe(tmpOE__Mic_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Mic_net[0:0]}),
		  .analog({Net_74}),
		  .io({tmpIO_0__Mic_net[0:0]}),
		  .siovref(tmpSIOVREF__Mic_net),
		  .interrupt({tmpINTERRUPT_0__Mic_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Mic_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
